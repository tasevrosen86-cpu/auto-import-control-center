...
export const MOBILE_BG_FIELD_MAP: MobileBgFieldDef[] = [
  ...
  { key: 'color', mobile_bg_label: 'Цвят', our_db_key: 'color', field_type: 'select', required: false, source: 'encar', agent_can_fill: true, needs_human_confirmation: true, section: 'basic', options: ['Бял','Черен','Сив','Сребърен','Златен','Червен','Син','Зелен','Кафяв','Жълт','Оранжев','Бежов','Лилав','Друг'] },
  ...
  { key: 'vat_included', mobile_bg_label: 'Цената с ДДС ли е', our_db_key: 'vat_included', field_type: 'select', required: true, source: 'manual', agent_can_fill: true, needs_human_confirmation: false, section: 'price', options: ['Цената е с включено ДДС', 'Цената е без ДДС', 'Частна продажба./Освободена от ДДС продажба'] },
...
export const DRAFT_STATUS_LABELS_BG: Record<string, string> = {
  ...
  PUBLISH_LOGIN_REQUIRED: 'Нужен е вход в Mobile.bg',

...
type Extra = { draft_id:string; extra_key:string; mobile_bg_label:string; group_name:string; selected:boolean };
...
type Draft = DraftRow & { fields:Field[]; images:Array<{id:string;is_selected:boolean}>; extras:Extra[] };
...
export function Publications(){
  ...
  const load=useCallback(async()=>{
    const [jobsResult,draftsResult,fieldsResult,imagesResult,extrasResult,publishResult]=await Promise.all([
      ...
      supabase.from('publication_draft_extras').select('draft_id,extra_key,mobile_bg_label,group_name,selected').order('group_name').order('mobile_bg_label'),
